...
#ifdef	_WINDOWS
#ifdef	JUMAN_KNP_DLL
#define JUMAN_KNP_API		__declspec(dllexport)
#define JUMAN_KNP_DATA		__declspec(dllexport)
#else	/* JUMAN_KNP_DLL */
#define JUMAN_KNP_API		__declspec(dllimport)
#define JUMAN_KNP_DATA		__declspec(dllimport)
#endif	/* JUMAN_KNP_DLL */
#endif	// _WINDOWS

#ifdef	_LINUX
#ifdef	_MAC
#define JUMAN_KNP_API	__attribute__((visibility("default")))
#define JUMAN_KNP_DATA	__attribute__((visibility("default")))
#else
#define JUMAN_KNP_API
#define JUMAN_KNP_DATA
#endif
#endif	// _LINUX
 ...
 */
#ifdef _WIN32
JUMAN_KNP_API char *toStringEUC(const char *str);
char *toStringSJIS(const char *str);
char **toStringEUCs(char **str_array);
void freeStrings(char **str_array);
...
extern JUMAN_KNP_DATA char* al_juman_dic;
extern JUMAN_KNP_DATA char* al_knp_dic;
extern JUMAN_KNP_DATA char* al_knp_rule;
...
FILE	*pathfopen(const char *filename, const char *mode,	
		   const char *path, char *filename_path);
FILE	*my_pathfopen(const char *filename, const char *mode,	
			  const char *path, char *filename_path);
int my_feof(FILE *fp);
...
void cha_exit(int status, const char *format,
		char *a=NULL, char *b=NULL, char *c=NULL, char *d=NULL,
		char *e=NULL, char *f=NULL, char *g=NULL, char *h=NULL);
...
extern	JUMAN_KNP_DATA FILE *Jumanrc_Fileptr;
...
extern	JUMAN_KNP_DATA int	   Show_Opt1;
extern	JUMAN_KNP_DATA int	   Show_Opt2;
extern	JUMAN_KNP_DATA char Show_Opt_tag[MIDASI_MAX];
extern	JUMAN_KNP_DATA int		Show_Opt_jumanrc;
extern	JUMAN_KNP_DATA int		Show_Opt_debug;

extern JUMAN_KNP_DATA U_CHAR StringBuff[LENMAX];
