...
static char* RESULT_2[] = {
	...
	"前部の修正", "含まれる前", "含まれる後", "誤り", NULL };
static char hei_kekku_2[] = "並結句数:%d";
static char hei_bunsetsu_2[] = "並結文節数:%d";
#endif
...
static const char *RESULT[] = {
	"重なりなし", "少し重なる", "前で重なる", "後で重なる",  "重複",
	"前部の修正", "含まれる前", "含まれる後", "誤り", NULL};
static const char hei_kekku[] = "並結句数:%d";
static const char hei_bunsetsu[] = "並結文節数:%d";
#endif
